...
from news_data_scraper.document.export.word.add_page_headers import (
    add_heading_and_author,
)
from news_data_scraper.document.export.word.add_title_source_date import add_article
from news_data_scraper.document.export.word.add_podcasts_and_websites import (
    add_podcast_and_website_links,
)
...
def export_to_word(
    document_contents: NewsDocument, output_file_name: str, output_file_path: Path
) -> None:
    document = Document()
